...
| --------------------------------------------- | ----------------------------------------------- |
| ![수면 메인](docs/screenshots/sleep_main.jpg) | ![수면 상세](docs/screenshots/sleep_detail.jpg) |
...
| ------------------------------------------------- | --------------------------------------------------- |
| ![코골이 메인](docs/screenshots/snoring_main.jpg) | ![코골이 상세](docs/screenshots/snoring_detail.jpg) |

총 코골이 시간, 평균/최대 dB, 발생 횟수, 시간대별 강도, 감지된 코골이 녹음 재생 기능을 제공합니다.

### 🌙 탐험

<img src="docs/screenshots/explore.jpg" width="300" alt="탐험">
...
| 일별 통계                                      | 월별 통계                                        |
| ---------------------------------------------- | ------------------------------------------------ |
| ![일별 통계](docs/screenshots/stats_daily.jpg) | ![월별 통계](docs/screenshots/stats_monthly.jpg) |

일별 수면 점수, 산소포화도 추이와 최근 3개월 요약, 월평균 수면 시간 추세를 확인할 수 있습니다.

### 🏷️ 수면 태그 분석

<img src="docs/screenshots/sleep_tag_analysis.jpg" width="300" alt="수면 태그 분석">
